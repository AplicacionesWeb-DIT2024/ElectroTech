...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="relative p-2 transition-all duration-150 rounded-lg shadow-md sm:shadow-none sm:hover:shadow-md bg-white dark:bg-neutral-900">
            ...
            <CarouselItem key={index} className="group relative">
              ...
              <Link href={`/product/${product.id}`}>
                <img
                  src={image}
                  alt={product.nombre}
                  className="aspect-[5/4] w-full object-cover rounded-xl cursor-pointer"
                />
              </Link>
